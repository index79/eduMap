...
import 'package:eduMap/utils/utils.dart';
...
class HomePageState extends State<HomePage> {
  ...
  final List<PopupChoices> choices = <PopupChoices>[
    PopupChoices(title: '프로필', icon: Icons.settings),
    PopupChoices(title: '로그아웃', icon: Icons.exit_to_app),
  ];
  ...
  void showNotification(RemoteNotification remoteNotification) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      Platform.isAndroid ? "com.ablock.edumap" : 'com.ablock.edumap',
      'EduMap',
      playSound: true,
